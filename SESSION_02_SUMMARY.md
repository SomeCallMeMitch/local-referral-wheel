...
Keep three front-runners:
- **A: Managed referral circle**, dues-funded, small and narrowly focused.
- **E2: Ongoing partnership management**, paid on eligible relationship-derived deals; compare no base, low base + fee, fee credits, and flat retainer.
- **C: Implementation club**, a separate recurring or finite execution service.
...
Eight × $199 = $1,592/month gross. At modeled 18 hours and $200 fixed + 3% payment costs, cash contribution is $1,344.24 or $74.68/hour before tax and unquoted costs. Including 48 assumed startup/recruitment hours, first 90-day contribution/hour falls to $39.54 before one-time setup bills. At a $50/hour labor target, first-cohort economic contribution is negative; it is a learning investment, not instant high-margin income.

A 10% revenue fee consumes one-third of gross profit at a 30% job margin. But the founder's actual fee basis is unknown, and ongoing relationship services may justify different terms. No universal fee selected.

## Largest changes from original thesis
1. Membership, workshops and SaaS are optional business choices.
2. Ongoing relationship coordination is a serious standalone product.
3. Introducers and recipients need not pay the same way or produce equal referrals.
4. A one-time partnership project may be better than forcing recurring dues.
5. Revenue attribution, incremental benefit and profit are separate.
6. A small payment can signal commitment without being sufficient operating revenue.
7. Repeated-deal fees remain open; undefined lifetime claims are not assumed.

## Deferred or excluded from benchmark
Custom software, AI advice, broad KPI dashboards, large curriculum, licensing, experts and included agency work. No guaranteed referrals or causal ROI from gross revenue. No blanket permission for transaction fees across industries. Original research preserved unchanged.

## Biggest risks and assumptions
...
4. [Pricing and economics](pilot/03_PRICING_AND_ECONOMICS.md)
5. [Assumptions](strategy/05_ASSUMPTION_REGISTER.md)
6. [Open questions](strategy/07_OPEN_QUESTIONS.md)
7. [Work log and assignment coverage](SESSION_02_WORK_LOG.md)

Current working documents supersede recommendations in the original numbered root files only for this exploratory session. The original files remain historical research, not instructions that the next model must preserve as strategy.
